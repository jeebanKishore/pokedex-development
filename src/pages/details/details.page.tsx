...
interface PokemonData {
    stats?: Array<{ base_stat: number; stat: { name: string } }>; // Define the structure of stats
    // Add other properties as needed
}
const DetailPage: React.FC<DetailPageProps> = ({ isCardSelected, toggleModal, pokemonId, offset }) => {
    const [currentPokemonId = 0, setCurrentPokemonId] = useState(pokemonId);
                    ...
                    <>
                        <div className="model-container">
                            <Modal.Header closeButton={false} className="rs-modal-header-2">
                                ...
                                <div className="padding-components">{pokemonTypeData && <PropertyCard speciesData={pokemonSpeciesData} data={data} pokemonTypeData={pokemonTypeData} />}</div>
